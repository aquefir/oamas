/*
    ...
    OpenGL ES loader generated by glad 0.1.34 on Sun Mar 14 21:01:53 2021.
    ...
    Commandline:
	--profile="compatibility" --api="gles2=2.0" --generator="c" --spec="gl"
   --extensions="" Online:
...
static int get_exts( void )
{
	...
	else
	{
		...
		{
			const char * gl_str_tmp = (const char *)glGetStringi(
				GL_EXTENSIONS, index );
...
static void load_GL_ES_VERSION_2_0( GLADloadproc load )
{
	...
	glad_glReleaseShaderCompiler = (PFNGLRELEASESHADERCOMPILERPROC)load(
